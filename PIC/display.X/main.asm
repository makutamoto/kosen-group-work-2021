...
HSYNC		MACRO		TYPE	; Wait 18 instructions after SYNC.
	...
	;   Start of waiting time after rising edge (10 instructions)
	...
	NOP
	NOP
	;   End of waiting time after rising edge
...
I += 1
	...
	;   Start of drawing area (128 instructions)
	IF	TYPE == HSYNC_TYPE_PRE_DRAW
I = 0
		BSF		STATUS, RP0
	WHILE	I < D'5'
...
CALIBRATION	MACRO		COUNT ; wait 16 instructions
...
NOT_ZERO:	CALL		NOP10CYCLES
		...
		NOP
		GOTO		LOOP
ZERO:		CALL		NOP10CYCLES
		ENDM
		
SEND_DATA	MACRO		; wait 15 instructions
		LOCAL		LOOP, NOT_ZERO, ZERO
		CLRF		TILE_ROW
		MOVLW		D'48'
		MOVWF		TEMP0
